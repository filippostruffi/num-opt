...
def main() -> None:
    ...
    for opt_name in optimizer_names:
        ...
        # Rebuild the model to ensure pretrained weights (e.g., HF Transformers) are restored,
        # instead of resetting parameters which would randomize pretrained layers.
        model = MODEL_REGISTRY[args.model](task=task, dataset=train_ds).to(device)
